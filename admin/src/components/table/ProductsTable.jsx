                    ...
                    <table className='w-full table-auto'>
                        ...
                        <tbody>
                            {data?.products.map((product, index) => (
                                <tr key={index}>
                                    <>
                                        <td className='flex flex-col gap-4 sm:flex-row sm:items-center border-b border-[#eee] py-5 px-4 dark:border-strokedark'>
                                            <img
                                        ...
                                        <td className='border-b  border-[#eee]  py-5 px-4 dark:border-strokedark'>
                                            <button
                                                ...
                                                className={`flex flex-row gap-2 w-22 overflow-hidden cursor-pointer rounded ${
                                                    product.status === "Attivo"
                                                        ? "bg-success"
                                                        : "bg-danger"
                                                } text-white pl-3 py-1 text-sm font-medium pr-4`}
                                            >
                                                {product.status}
                                                <span className='down Dropdown-arrow'></span>
                                            </button>
                                            <div
                                                className={`${
                                                    dropdown === index
                                                        ? ""
                                                        : "hidden"
                                                } absolute z-999 rounded-sm border border-stroke bg-white p-1.5 shadow-default dark:border-strokedark dark:bg-boxdark block translate-y-0.5 w-30`}
                                            >
                                                <div className='flex flex-col'>
                                                    <a
                                                        className='cursor-pointer flex w-full items-center gap-2 rounded-sm py-1.5 px-4 text-left text-sm hover:bg-gray dark:hover:bg-meta-4'
                                                        onClick={() =>
                                                            handleChange(
                                                                product._id,
                                                                "Attivo",
