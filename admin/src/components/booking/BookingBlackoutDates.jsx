...
import { useBookingBlackoutDaysStore } from "../../store/zustand/store";

const BookingBlackoutDates = ({
    startDate,
    setStartDate,
    date,
    setDate,
    ...
    const blackoutDays = useBookingBlackoutDaysStore((state) => state.data);
    const blackoutDaysLoading = useBookingBlackoutDaysStore(
        (state) => state.loading
    );
...
export default BookingBlackoutDates;

BookingBlackoutDates.propTypes = {
