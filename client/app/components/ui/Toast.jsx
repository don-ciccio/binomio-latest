...
import { useToastStore } from "@/app/lib/store";
...
const Toast = () => {
    ...
    return (
        <RadixToast.Provider swipeDirection='right' duration={2500}>
            <RadixToast.Root
                className={`grid grid-cols-[auto_max-content] items-center gap-x-[15px] rounded border-l-4 ${toastObj?.status} bg-skin-base py-2 px-4  shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] [grid-template-areas:_'title_action'_'description_action'] data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=cancel]:translate-x-0 data-[state=open]:animate-slideIn data-[state=closed]:animate-hide data-[swipe=end]:animate-swipeOut data-[swipe=cancel]:transition-[transform_200ms_ease-out]`}
                open={open}
            ...
            >
                ...
                <RadixToast.Description asChild>
                    <span className='m-0 text-[13px] leading-[1.3] text-skin-dark [grid-area:_description] font-medium'>
