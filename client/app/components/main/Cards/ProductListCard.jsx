...
const ProductListCard = ({ name, price, images, id, description }) => {
    ...
    return (
        <div
            ...
            className={
                "cursor-pointer w-full p-2 bg-white-200 hover:bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-gray-200 to-white/40 rounded-3xl flex flex-row mx-auto h-40"
            }
        >
